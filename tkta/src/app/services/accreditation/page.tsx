  ...
  return (
    <section className="w-full flex flex-col gap-16 items-center">
      ...
      >
        ...
        <TabsContent value="accreditation-council">
          <div className="flex flex-col gap-4">
            <div>
        ...
        <TabsContent value="internationalization">
          <div className="flex flex-col gap-6">
            <div>
              ...
              əməkdaşlıqlara önəm verir və Azərbaycan ərazisində fəaliyyət
              göstərən təhsil müəssisələri, o cümlədən digər hökumət və qeyri -
              hökumət təşkilatları ilə əməkdaşlıq etməkdədir.
            </div>

            <div>
              Təhsildə Keyfiyyət Təminatı Agentliyi 2017-ci ilin Yanvar ayından
              Avropa Ali Təhsil Məkanında Keyfiyyətin Təminatı üzrə
              Assosiasiyaya (ENQA) müşahidəçi üzv statusu əldə edib. Avropanın
              aparıcı akkreditasiya qurumlarını birləşdirən ENQA-da təmsil
              olunmaq Azərbaycana Avropa ali təhsil məkanında təhsilin
              ...
              daha da yaxınlaşmaq və Keyfiyyətin Təminatı üzrə Avropa
              Standartları və Təlimatlarına (ESG) cavab verən akkreditasiya
              sistemini qurmağa şərait yaradır.
            </div>
            ...
            <div>
              ...
              təminatı üzrə Avropa Assosiasiyasının (ENQA), Avropa
              Universitetlər Assosiasiyasının (EUA), Ali təhsil müəssisələrinin
              Avropa Assosiasiyasının (EURASHE) və Avropa Tələbələr Birliyinin
              (ESU) təşəbbüsü əsasında ali təhsildə keyfiyyətə nəzarət üçün
              yaradılmış ilk rəsmi qurumdur. Ümumilikdə 36 ölkə EQAR-ın üzvüdür.
            </div>
          </div>
        </TabsContent>
