  ...
  return (
    <section className="w-full flex flex-col gap-16 items-center">
      ...
      >
        ...
        <TabsContent value="expert-registration">
          <div className="flex flex-col gap-4 text-justify">
            <div className="w-full flex flex-col gap-3 text-justify">
              <h2 className="text-lg text-center font-semibold text-textPrimary">
                Ali təhsil müəssisələri üçün
              </h2>

              <p>Namizədə olan tələblər</p>
            ...
            <div className="w-full flex flex-col gap-3 text-justify">
              <h2 className="text-lg text-center font-semibold text-textPrimary">
                Peşə təhsili müəssisələri üçün
              </h2>

              <p className="font-bold">Namizədlər üçün tələblər:</p>
