...
import { international_reports } from "@/data/international_accreditation_reports";
  ...
  return (
    <section className="w-full flex flex-col gap-16 items-center">
      ...
      <h1 className="uppercase text-6xl text-center w-full px-[112px]">
        Beynəlxalq Akkreditasiya hesabatları
      </h1>

      <div className="grid grid-cols-4 px-16 gap-6">
        {international_reports.map((report) => (
          <Link key={report.id} target="_blank" rel="noopener noreferrer" href={report.link}>
