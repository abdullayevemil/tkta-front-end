  ...
  return (
    <section className="w-full flex flex-col gap-16 items-center">
      ...
      >
        ...
        <TabsContent value="expert-preparation"></TabsContent>

        <TabsContent value="expert-registration"></TabsContent>

        <TabsContent value="qualification-ambassador"></TabsContent>
      </Tabs>
    </section>
  );
}
