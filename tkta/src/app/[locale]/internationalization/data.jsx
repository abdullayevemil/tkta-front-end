      ...
      <duv>
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              müzakirə ediblər.Eyni zamanda İdarə Heyəti tərəfindən qurumun yeni
              prezidenti olaraq Xorvatiyanın Elm və Ali Təhsil Agentliyinin
              direktor müavini Vesna Dodiković-Jurković, vitse-prezidenti olaraq
              isə Beynəlxalq Biznes İdarəetmə Akkreditasiyası Fondunun (FIBAA)
              icraçı direktoru Diane Freiberger seçilib.
            </p>

            <p className="mb-4">
              Qeyd edək ki, CEENQA Baş Assambleyasında Almaniya, Estoniya,
              Latviya, Litva, Çexiya, Slovakiya, Macarıstan, Rumıniya, Moldova,
              Sloveniya, Bosniya və Herseqovina, Serbiya, Bolqarıstan, Birləşmiş
              Krallıq, Türkiyə, Ukrayna və Qazaxıstandan keyfiyyət təminatı
              agentliklərinin rəhbərləri, eləcə də Avropa Ali Təhsil Məkanında
              Keyfiyyət Təminatı üzrə Assosiasiyayanın (ENQA), Ali Təhsil üzrə
              Avropa Keyfiyyət Təminatı Reyestri (EQAR) və Ali Təhsildə
              Keyfiyyət Təminatı Agentliklərinin Beynəlxalq Şəbəkəsinin
              (INQAAHE) nümayyəndələri iştirak edib.
            </p>
            ...
            <p className="mb-4">
              Onu da bildiririk ki, TKTA 2021-ci ilin oktyabr ayından CEENQA-nın
              tam hüquqlu üzvüdür.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              CIMEA-nın təşkilatçılığı ilə “Lissabon Tanınma Konvensiyası” üzrə
              Boloniya prosesinin Tematik İşçi Qrupunun 7-ci görüşündə iştirak
              edib.
            </p>
            ...
            <p className="mb-4">
              ...
              keçirilməsinə şərait yaradan hüquqi bazanın yaradılması, qaçqın və
              məcburi köçkünlərin kvalifikasiyalarının tanınması,
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              25-26 aprel 2024-cü il tarixlərində Türkiyə Respublikasının Ankara
              şəhərində Türkiyə Ali Təhsildə Keyfiyyət Təminatı Şurasının
              (YÖKAK) və Hacı Bayram Vəli Universitetinin təşkilatçılığı ilə
              “YÖKAK 2024-Keyfiyyət təminatı və akkreditasiya” adlı beynəlxalq
              konfransı keçirilib.
            </p>
            ...
            <p className="mb-4">
              ...
              təminatı sahəsində nüfuzlu beynəlxalq təşkilatların məsul şəxsləri
              yer alıb.
            </p>

            <p className="mb-4">
              Tədbirin açılış mərasimində Türkiyə Respublikası Ali Təhsil
              Şurasının sədri cənab Erol Özvar, Ali Təhsildə Keyfiyyət Təminatı
              Şurasının sədri cənab Ümit Kocabıçak, Avropa Ali Təhsil Məkanında
              Keyfiyyətin Təminatı üzrə Assosiasiyanın (ENQA) vitse-prezidenti
              xanım Doris Herrman çıxış edib, Ali Təhsil üzrə Avropa Keyfiyyət
              Təminatı Reyestri (EQAR) prezidenti cənab Stephan Lauwick-in
              konfransa videomüraciəti yayımlanıb.
            </p>
            ...
            <p className="mb-4">
              ...
              genişləndiyini və ənənəvi təhsil müəssisələrinin bu prosesə çevik
              adaptasiyasının önəmini vurğulayıb, həmçinin bir sıra ali təhsil
              müəssisələrinin yerli akkreditasiya və digər xarici keyfiyyət
              təminatı proseslərini keçmələrinə rəğmən həmin müəssisələrdə
              təşkil olunan tədrisin keyfiyyəti və təqdim olunan ali təhsil
              kvalifikasiyaların əmək bazarında rəqabətə davamlı olmadığını qeyd
              edib.
            </p>
            ...
            <p className="mb-4">
              ...
              təminatının tətbiqi və problemləri&quot; sessiyasında &quot;Xarici
              ali təhsil ixtisaslarının tanınmasında təhsil proqramlarının
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              təminatı departamentinin direktoru İlham Hümbətov və Akkreditasiya
              və lisenziya şöbəsinin müdiri Elmar Mustafayev iştirak edib.
            </p>
            ...
            <p className="mb-4">
              ...
              inkişaf edən rolu ilə bağlı müzakirələr də daxil olmaqla bir neçə
              mühüm plenar sessiyaslar keçirilib və iştirakçılar arasında fikir
              mübadiləsi aparılıb.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              Təhsildə Keyfiyyət Təminatı Agentliynin nümayəndələri Avropa Təlim
              Fondunun (ATF) təşkilatçılığı və Türkiyə Respublikasının Peşə
              Kvalifikasiyaları Agentliyinin tərəfdaşlığı ilə Ankara şəhərində
              keçirilən “Qeyri-formal və informal təhsilin tanınması
              mexanizmlərinin təkmilləşdirilməsi” adlı beynəlxalq tədbirdə
              iştirak ediblər.
            </p>

            <p className="mb-4">
              Tədbirin əsas məqsədi tərəfdaş ölkələrdə qeyri-formal və informal
              yollar ilə əldə edilən kvalifikasiyaların tanınması
            ...
            <p className="mb-4">
              ...
              yaradılması haqqında ilkin razılıq əldə edilib və gələcək planlar
              müzakirə olunub.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              Portuqaliyada baş tutan Avropa Keyfiyyət Təminatı Forumunda (EQAF)
              iştirak edib.
            </p>
            ...
            <p className="mb-4">
              ...
              əməkdaşlıq sahəsində yaranan problemlərin və imkanların həlli üçün
              yeni siyasətlərin, tendensiyaların və təcrübələrin araşdırılmasına
              yönəldilib.
            </p>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              müvəqqəti icra edən Kamran Rəsulov açılış nitqi ilə çıxış edərək,
              qonaqları salamlayıb və əlaqəli sahədə bugünə kimi görülmüş işlər
              barədə məlumatı konfrans iştirakçılarının diqqətinə çatdırıb.
            </p>

            <p className="mb-4">
              Tədbirdə çıxış edən elm və təhsil nazirinin müavini Həsən Həsənli
              öz çıxışında ümumi təhsil sahəsində aparılan islahatlardan
              danışıb, müasir dövrün tələbinə uyğun yeni çağırışlar və onların
              həlli istiqamətində diqqət yetirilməli məqamları vurğulayıb.
            </p>

            <p className="mb-4">
              Tədbir Azərbaycan Respublikasının Elm və Təhsil nazirliyi Ümumi və
              məktəbəqədər təhsilin təşkili və idarə olunması şöbəsinin müdiri,
              Azərbaycan Respublikası Təhsil İnstitutunun direktor
            ...
            <p className="mb-4">
              ...
              etdirilməsi: Problemlər və Perspektivlər” adlı panel müzakirələrlə
              davam edib.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              Tədbirdə Avropa keyfiyyət təminatı üzrə standartlar və təlimatlar
              sənədinin (ESG) təkmilləşdirilməsi, keyfiyyət təminatında
              tədqiqat, rəqəmsallaşma, data-əsaslı qərarvermə, keyfiyyət
              təminatı agentlikləri arasında əməkdaşlıq kimi mühüm mövzular
              müzakirə olunub. Eyni zamanda, Baş Assambleya çərçivəsində ENQA
              İdarə Heyətinə seçkilər keçirilib.
            </p>

            <p className="mb-4">
              Bildiririk ki, ENQA-nın dəstəyi ilə həyata keçirilən SEGA-ESG II
              layihəsi çərçivəsində digər 3 ölkədə (Bosniya-Herseqovina, Serbiya
              və Ukrayna) olduğu kimi Azərbaycanda da milli keyfiyyət təminatı
              agentliyi olan TKTA-nın ENQA-ya tamhüquqlu üzvlüyünün
              dəyərləndirilməsi məqsədilə fəaliyyət planı hazırlanıb və
              aidiyyəti üzrə ENQA-ya təqdim olunub. Növbəti il ərzində TKTA-nın
              ENQA-ya üzvlük prosesi ilə əlaqəli Özünütəhlil hesabatının
              hazırlanması və ENQA-nın müvafiq komissiyasının TKTA-ya sahə
        ...
        <div className="flex flex-col gap-6">
          <h2 className="text-2xl text-textPrimary font-bold">
            TKTA əməkdaşları SEQA-ESG II layihəsi çərçivəsində tədbirdə iştirak
            edib
          </h2>
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            <p className="mb-4">
              ...
              lisenziya şöbəsinin əməkdaşları Faina Qaçabəyova və Nigar Əsgərova
              Avropa keyfiyyət təminatı agentliklərinin Avropa keyfiyyət
              təminatı üzrə standartlar və təlimatlar sənədinə (ESG)
              uyğunlaşmağa dəstək (SEQA-ESG II) layihəsi çərçivəsində keçirilmiş
              beynəlxalq seminarda iştirak ediblər.
            </p>

            <p className="mb-4">
              Tədbir Belçikanın Brüssel şəhərində ali təhsil müəssisələrinin
              proqram akkreditasiyasını həyata keçirən VLUHR QA təşkilatının ev
              sahibliyi ilə keçirilib. “SEQA-ESG II Ekspertlərin qarşılıqlı
              öyrənmə seminar”ı başlığı altında təşkil olunmuş tədbirdə xarici
              keyfiyyət təminatı proseslərinə cəlb edilən ekspertlərə metodoloji
              istiqamətin verilməsi və onlarla səmərəli fəaliyyətin həyata
              keçirilməsinə müvafiq dəstəyin göstərilməsi nəzərdə tutulub.
            </p>
            ...
            <p className="mb-4">
              ...
              2025-ci il 30 noyabr tarixində bitdikdən sonra sözügedən ölkələrdə
              fəaliyyət göstərən keyfiyyət təminatı agentliklərinin ENQA-ya tam
              hüquqlu üzvlüyü dəyərləndiriləcəkdir.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              şəhərində Qazaxıstanın Müstəqil Akkreditasiya və Reytinq Agentliyi
              tərəfindən Astana IT Universitetində “İnformasiya məkanında
              təhsildə keyfiyyətin yüksəldilməsi ali təhsil müəssisələrinin
              strateji inkişaf fenomeni kimi” adlı Mərkəzi-Asiya Təhsildə
              Keyfiyyət Təminatı VIII Beynəlxalq Forumu keçirilmişdir.
            </p>

            <p className="mb-4">
              Sözügedən tədbirdə Təhsildə Keyfiyyət Təminatı Agentliyinin İdarə
              Heyətinin sədr müavini Kamran Rəsulov iştirak etmişdir. Adıçəkilən
              tədbirdə Avropa Ali Təhsil Məkanında Keyfiyyət Təminatı üzrə
              Assosiasiyanın (ENQA) prezidenti Duqlas Blakstok, Ali Təhsil üzrə
              Avropa Keyfiyyət Təminatı Reyestrinin (EQAR) prezidenti Stefan
              Lauvik, eləcə də dövlət rəsmiləri, Mərkəzi-Asiya ölkələrindən
              müvafiq ali təhsil müəssisələrinin rəhbər şəxsləri və beynəlxalq
              ali təhsil keyfiyyət təminatı şəbəkələrinin nümayəndələri iştirak
              etmişlər.
            </p>

            <p className="mb-4">
              Qeyd edək ki, hər il keçirilən Forumda təhsildə daxili və xarici
              keyfiyyət təminatı sisteminin inkişafı, xarici təhsil təşkilatları
              arasında əməkdaşlığın genişləndirilməsi, keyfiyyət mədəniyyətinin
              inkişafı, elm icmasının konstruktiv inteqrasiyası və süni
              intellektin təhsildə keyfiyyət təminatının inkişafına təsiri
              haqqında müzakirələr aparılmışdır.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              ilə əməkdaşlıq çərçivəsində 2024-cü il 26-27 sentyabr tarixlərində
              31 ali təhsil müəssisəsindən 55 mütəxəssisin iştirakı ilə ali
              təhsildə keyfiyyət təminatı üzrə ilk simpoziuma ev sahibliyi
              etmişdir. Tədbirin açılış nitqində TKTA-nın İdarə Heyətinin sədri
              Tural Əhmədov ali təhsil müəssisələrinin institusional
              akkreditasiyası kontekstində keyfiyyət təminatının əhəmiyyəti,
              əldə olunmuş təcrübə və ümumi tendensiyalar barədə faktları
            ...
            <p className="mb-4">
              ...
              keyfiyyət təminatı mexanizmlərinin müxtəlif strukturları haqqında
              fikirlərini bölüşüblər. Tədbir, ali təhsil müəssisələri arasında
              əməkdaşlıq və fikir mübadiləsi üçün platforma rolunu oynamışdır.
            </p>

            <p className="mb-4">
              Tədbirdən sonra ADA Universitetinin Keyfiyyət Təminatı və
              Akkreditasiya şöbəsinin rəhbəri Maurus Roller simpoziumun uğurunu
              vurğulayaraq belə qeyd etmişdir: “Bu iki gün ərzində müsbət və
              məhsuldar mühit bütün gözləntilərimi qarşıladı. Bu, mövzunun
              əhəmiyyətini və ölkənin ali təhsil müəssisələrində keyfiyyət
              təminatı sahəsində çalışanların töhfələrini bir daha sübut edir.”
            </p>

            <p className="mb-4">
              Bu fikri Almaniyanın Potsdam Universitetində Keyfiyyət və İnkişaf
              Mərkəzinin rəhbəri və tədbirin spikerlərindən biri olan Frank
              Niedermeier də bölüşüb: “Simpozium yaxşı təşkil olunmuşdu. Bu
              tədbirin bir hissəsi olmaqdan məmnun oldum, bu, təkcə iştirakçılar
              üçün deyil, həm də mənim üçün yaxşı bir təcrübə oldu.”
            </p>

            <p className="mb-4">
              ADA Universitetinin akademik işlər üzrə prorektoru Elkin
              Nurməmmədov isə simpoziumun uğurunu nəzərə alaraq bu tədbirin hər
              il ənənəvi olaraq keçirilməsini planlaşdırdıqlarını qeyd edib.
            </p>
            ...
            <p className="mb-4">
              ...
              təcrübələri paylaşmalarına, ümumi məsələlər və layihələr üzərində
              birgə işləmələrinə imkan verəcək bir platforma yaratmaq niyyətində
              olduqlarını ifadə etmişlər.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              sentyabr tarixlərində Finlandiyanın Helsinki və Estoniyanın Tallin
              şəhərlərində baş tutan “Təhsilverənlərin tədris peşəkarlığının
              inkişaf etdirilməsi” təlim proqramında iştirak etmişdir. Təlim
              Finlandiya Respublikasının Təhsil və Mədəniyyət Nazirliyi,
              Estoniya Respublikasının Təhsil və Tədqiqat Nazirliyi və Avropa
              Təlim Fondu (ETF) tərəfindən birgə təşkil olunmuşdur.
            </p>
            ...
            <p className="mb-4">
              ...
              olmuş, ümumtəhsil, peşə ixtisas və ali təhsil müəssisələrinə sahə
              səfərlərində iştirak edərək müəssisələrin akademik və inzibati
              heyəti ilə müzakirələr aparmışdır.
            </p>

            <p className="mb-4">
              Tədbirin ikinci günündə Finlandiya Təhsil Qiymətləndirmə Mərkəzi
              (FİNEEC) ilə görüş keçirilmiş, təhsildə keyfiyyət təminatı
              sahəsində Finlandiya təcrübəsi ilə bağlı təqdimat dinlənilmişdir.
            </p>
          </div>
        </div>
      </duv>
      ...
      <div>
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              keyfiyyət təminatı, ikili proqramların keyfiyyət təminatına Avropa
              yanaşması, Bolonya Prosesi üzrə İcra Hesabatının keyfiyyət
              təminatına həsr olunmuş fəslinin tamamlanması vəziyyəti barədə
              təqdimatlarla tanış olub. Görüşün ikinci günündə Tematik Qrupun
              gələcək prioritet mövzuları barədə təqdimatlar ətrafında
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              ...
              Xarici kvalifikasiyaların tanınması şöbəsinin (XKTŞ) müdiri Elnur
              Xəlilov və adıçəkilən şöbənin əməkdaşı Nigar Cəniyeva Türkiyə
              Respublikası Milli Təhsil Nazirliyinin (MEB) Təlim və Metodologiya
              Şurasının (Talim ve Terbiye Kurulu) və Türkiyə Respublikası Ali
              Təhsil Şurasının (YÖK) təcrübəsi ilə tanış olmaq məqsədilə həmin
              ölkəyə səfər ediblər.
            </p>
            ...
            <p className="mb-4">
              ...
              Türkiyənin əmək bazarına inteqrasiyası, qiymətləndirmə və tanınma
              prosesləri, nəzəri və praktiki imtahanların təşkilinə dair
              məsələlər ilə bağlı fikir mübadiləsi aparılıb. Həmçinin, tərəflər
              arasında qarşılıqlı əməkdaşlıq perspektivləri müzakirə edilib.
            </p>

            <p className="mb-4">
              Səfər zamanı MEB Təlim və Metodologiya Şurasının xaricdə əldə
              edilmiş tam orta təhsil attestatlarının tanınmasından məsul Təhsil
              siyasəti şöbəsinin müdiri Mustafa Kılıç və tanınma şöbəsinin məsul
              əməkdaşı Dinçer Koçer ilə görüş keçirilib. Görüşdə sözügedən
              təhsil sənədlərinin tanınma proseduru, bu prosesin mərhələləri və
              digər müvafiq məsələlər ətrafında müzakirələr aparılıb, eyni
              zamanda Türkiyənin bu sahədəki təcrübəsi yaxından öyrənilib.{" "}
            </p>
            ...
            <p className="mb-4">
              ...
              Kvalifikasiyalarının tanınması və ekvivalentliyin müəyyən edilməsi
              şöbəsinin müdiri Ayşə İnan və şöbənin mütəxəssisləri ilə görüş
              keçirilib. Bu görüşdə xarici kvalifikasiyaların tanınması, tələb
              olunan sənədlər və onların həqiqiliyinin yoxlanması, ixtisas
              ekvivalentliyinin müəyyən edilməsi, tənzimlənən ixtisaslarla bağlı
              imtahanların təşkili və digər məsələlər müzakirə olunaraq, YÖK-ün
              təcrübəsi ilə yaxından tanışlıq fürsəti yaranıb.
            </p>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              Təhsildə Keyfiyyət Təminatı Agentliyinin (TKTA) Akkreditasiya və
              lisenziya şöbəsinin əməkdaşı Xanım Quliyeva Sloveniyanın Lyublyana
              şəhərində işgüzar səfər olub. Səfərin əsas məqsədi Sloveniyanın
              Ali Təhsildə Keyfiyyət Təminatı Agentliyinin (NAKVIS/SQAA)
              təcrübəsi ilə tanışlıq və qarşılıqlı əməkdaşlıq imkanlarının
              müzakirəsi olub.
            </p>
            {/* 
              <Image
            ...
            <p className="mb-4">
              ...
              struktur bölmələrinin nümayəndələri ilə görüşlər keçirib. Görüşlər
              zamanı hər iki keyfiyyət təminatı agentliyinin akkreditasiya
              qiymətləndirilməsində rolu, Avropa Ali Təhsil Məkanında keyfiyyət
              təminatı üzrə standartlar və təlimatlardan (ESG) irəli gələn
              tələblərə uyğun fəaliyyətlərin təşkili, eləcə də Daxili keyfiyyət
              təminatı üzrə mövcud metodologiya və yanaşmalar ətrafında fikir
              mübadiləsi aparılıb.
            </p>

            <p className="mb-4">
              Bundan əlavə, NAKVIS/SQAA-nın Avropa Ali Təhsil üzrə Keyfiyyət
              Təminatı Assosiasiyasının (ENQA) tamhüquqlu üzvlüyü ilə bağlı son
              təcrübə öyrənilib və ESG standartlarına uyğunluğun təmin edilməsi
              üzrə həyata keçirilmiş fəaliyyətlərlə tanışlıq baş tutub.
            </p>
            ...
            <p className="mb-4">
              ...
              imkanlarının müzakirəsinə şərait yaratmaqla yanaşı, gələcək birgə
              fəaliyyətlər üçün güclü zəmin hazırlayıb. Təhsildə keyfiyyət
              təminatı sahəsində beynəlxalq təcrübənin öyrənilməsi və tətbiqi
              Agentliyin davamlı inkişafına xidmət edən əsas məqsədlərindən
              biridir.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-justify tracking-wide leading-7 text-base">
            ...
            <p className="mb-4">
              27-28 may 2025-ci il tarixlərində SEQA-ESG 2 layihəsi çərçivəsində
              Serbiya Respublikasının Novi Sad şəhərində Serbiya Milli Keyfiyyət
              Təminatı Agentliyinin (NEAQA) ev sahibliyi etdiyi növbəti təlim və
              təcrübə mübadiləsi həyata keçirilib.
            </p>

            <p className="mb-4">
              Tədbirdə Təhsildə Keyfiyyət Təminatı Agentliyinin (TKTA)
              akkreditasiya və lisenziya şöbəsinin aparıcı məsləhətçisi Xanım
              Quliyeva, təlim və metodologiya şöbəsinin böyük məsləhətçisi Bəyim
              Abdulla və analitik təhlil şöbəsinin böyük məsləhətçisi Gülnar
              Tahirli iştirak ediblər. Təlim zamanı Avropa standartları və
              bələdçi sənədinin (ESG) 3.6 (“Daxili keyfiyyət təminatı və peşəkar
              davranış”), ESG 3.4 (“Tematik təhlil”) və ESG 2.1 (“Daxili
              keyfiyyət təminatının nəzərə alınması”) standartları üzrə qabaqcıl
              təcrübələr təqdim edilib.{" "}
            </p>
            ...
            <p className="mb-4">
              ...
              milli səviyyədə akkreditasiya meyarlarında tətbiqi vəziyyəti üzrə
              fikir mübadiləsi aparıb və tematik təhlil üzrə keyfiyyət təminatı
              üzrə agentliklərin ortaq baxışlarının və çağırışlarının olduğu
              müəyyən olub.
            </p>
            ...
            <p className="mb-4">
              ...
              təhsildə keyfiyyət təminatı sahəsində müasir yanaşmaları gündəlik
              təcrübəyə inteqrasiya etmək baxımından mühüm əhəmiyyət kəsb edir.
            </p>
          </div>
        </div>
      </div>
