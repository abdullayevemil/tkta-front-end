...
export default function EditNewsPage() {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        const res = await axios.get(`/api/media/disclosures/${id}`);
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.put(`/api/media/disclosures/${id}`, formData);
      router.push("/media/disclosures");
    } catch (err) {
  ...
  return (
    <div className="flex flex-col gap-8 sm:gap-10 md:gap-12 items-center px-4 sm:px-8 md:px-16 w-full py-8 bg-white text-textPrimary font-sans">
      <h1 className="uppercase text-2xl sm:text-3xl md:text-4xl text-center w-full px-4 sm:px-8 md:px-16 pt-8 sm:pt-12 md:pt-16">
        {t.media.disclosures.editPage.title}
      </h1>
        ...
        <div className="md:w-2/5 flex flex-col gap-6">
          <div className="flex flex-col gap-1">
            <Label htmlFor="title" className="text-sm font-medium">
              {t.media.disclosures.create.titlePlaceholder}
            </Label>
            <Input
              id="title"
              type="text"
              ...
              placeholder={t.media.disclosures.create.titleInputPlaceholder}
            />
            {errors.title && (
          ...
          <div className="flex flex-col gap-1">
            <Label htmlFor="titleEnglish" className="text-sm font-medium">
              {t.media.disclosures.create.titleEnglish}
            </Label>
            <Input
              id="titleEnglish"
              type="text"
              ...
              placeholder={t.media.disclosures.create.titleEnglishInputPlaceholder}
            />
            {errors.titleEnglish && (
          ...
          <div className="flex flex-col gap-1">
            <Label htmlFor="date" className="text-sm font-medium">
              {t.media.disclosures.create.datePlaceholder}
            </Label>
            <Popover>
          ...
          <div className="flex flex-col gap-1">
            <Label className="text-sm font-medium mb-1 block">
              {t.media.disclosures.create.headerImage}
            </Label>
            <div
            ...
            >
              {headerImage ? (
                ...
                <p className="text-textPrimary text-center text-sm">
                  {t.media.disclosures.create.headerImageDescription}
                </p>
              )}
          ...
          <div className="flex flex-col gap-1">
            <Label className="text-sm font-medium mb-1 block">
              {t.media.disclosures.create.images}
            </Label>
            <div
            ...
            >
              {galleryImages.length === 0 ? (
                <p className="text-textPrimary text-center text-sm">
                  {t.media.disclosures.create.imagesDescription}
                </p>
              ) : (
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="note" className="text-sm font-medium">
              {t.media.disclosures.create.note}
            </Label>
            <Textarea
              id="note"
              value={note}
              ...
              placeholder={t.media.disclosures.create.noteInputPlaceholder}
            />
          </div>

          <div className="flex flex-col gap-2">
            <Label htmlFor="note" className="text-sm font-medium">
              {t.media.disclosures.create.noteEnglish}
            </Label>
            <Textarea
              id="note"
              value={noteEnglish}
              ...
              rows={3}
              className="w-full rounded-md border border-gray-300 p-2 text-black resize-none"
              placeholder={t.media.disclosures.create.noteInputEnglishPlaceholder}
            />
          </div>
        </div>
        ...
        <div className="md:w-3/5 flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <Label htmlFor="content" className="text-sm font-medium">
              {t.media.disclosures.create.contentPlaceholder}
            </Label>
            <div
              className={cn(
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="contentEnglish" className="text-sm font-medium">
              {t.media.disclosures.create.contentEnglish}
            </Label>
            <div
              className={cn(
                "rounded-md border border-gray-300 p-2 text-black",
      ...
      >
        {t.media.disclosures.editPage.submit}
      </Button>
    </div>
  );
}
