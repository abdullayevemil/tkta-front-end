export default function VideoInstructionsPage() {
  return (
    <div className="container w-full mx-auto px-4 sm:px-8 md:px-16 pt-2 sm:pt-4 md:pt-6 flex flex-col gap-6 items-center text-textPrimary">
      ...
      <video
        className="h-auto w-3/4 rounded-lg shadow-lg"
        controls
